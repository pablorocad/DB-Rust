...
fn main() {
    let mut vector_clientes: Vec<continental_motores::clientes::Cliente> = Vec::with_capacity(5);
    let mut vector_unidades: Vec<continental_motores::unidades::Unidad> = Vec::with_capacity(100);
